...
public class EmployeeEndToEndTest {
    ...
    public void setUp() {
        ...
        employee2.setAddress("155 Bridge Road, Glebe 2037 NSW");
        employee2.setEmployeeStatus(Employee.EmployeeStatus.CONTRACT);
        employee2.setStartDate(LocalDate.of(2023, 3, 10));
        employee2.setEndDate(LocalDate.of(2025, 3, 10));
        employee2.setHoursPerWeek(20);
    ...
    public void createEmployee_ValidData_ReturnsCreatedEmployee() {
        given()
            .contentType("application/json")
            .body("{\"firstName\": \"Alice\", \"lastName\": \"Johnson\", \"emailAddress\": \"alice.johnson@example.com\", \"mobileNumber\": \"0412345678\", \"address\": \"2 Glebe Point Road, Glebe, 2037 NSW\", \"status\": \"PERMANENT_FULL_TIME\", \"startDate\": \"2023-04-01\", \"hoursPerWeek\": 40}")
        .when()
            .post("/employees")
        .then()
            .statusCode(HttpStatus.CREATED.value())
